...
#
# FBR2.tcl: Tcl script for re-creating project 'FBR1'
#
# Generated by Vivado on Mon Apr 26 17:40:22 +0900 2021
...
#
# 1. This project restoration tcl script (FBR2.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "D:/Vivado_workspace/Vivado2020.2/FBR1/FBR1.srcs/constrs_1/imports/new/ZyboMaster.xdc"
#
...
set orig_proj_dir "[file normalize "$origin_dir/../FBR1"]"
...
set_property -name "top" -value "dsFBR1_wrapper" -objects $obj
...
set file "[file normalize ${origin_dir}/ZyboMaster.xdc]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "ZyboMaster.xdc"
...
# Proc to create BD dsFBR1
proc cr_bd_dsFBR1 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name dsFBR1
  ...
  # Create instance: fbr, and set properties
  set fbr [ create_bd_cell -type ip -vlnv xilinx.com:ip:v_frmbuf_rd:2.2 fbr ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {187.5} \
   CONFIG.PCW_FPGA2_PERIPHERAL_FREQMHZ {74.25} \
  ...
  # Create instance: rst_ps7_0_187M, and set properties
  set rst_ps7_0_187M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_187M ]

  # Create instance: rst_ps7_0_75M, and set properties
  set rst_ps7_0_75M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_75M ]
  ...
  connect_bd_intf_net -intf_net fbr_m_axi_mm_video [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins fbr/m_axi_mm_video]
  connect_bd_intf_net -intf_net fbr_m_axis_video [get_bd_intf_pins fbr/m_axis_video] [get_bd_intf_pins vid_out/video_in]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins video_lock_monitor/S_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins hls_ip_reset/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins fbr/s_axi_CTRL] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  ...
  connect_bd_net -net fbr_interrupt [get_bd_pins fbr/interrupt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net hls_ip_reset_gpio_io_o [get_bd_pins fbr/ap_rst_n] [get_bd_pins hls_ip_reset/gpio_io_o] [get_bd_pins rgb2dvi_0/aRst_n] [get_bd_pins vid_out/aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins v_tc_0/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins fbr/ap_clk] [get_bd_pins hls_ip_reset/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins rst_ps7_0_187M/slowest_sync_clk] [get_bd_pins vid_out/aclk]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_pins processing_system7_0/FCLK_CLK2] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins rgb2vga_0/PixelClk] [get_bd_pins rst_ps7_0_75M/slowest_sync_clk] [get_bd_pins v_tc_0/clk] [get_bd_pins vid_out/vid_io_out_clk] [get_bd_pins video_lock_monitor/s_axi_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in] [get_bd_pins rst_ps7_0_187M/ext_reset_in] [get_bd_pins rst_ps7_0_75M/ext_reset_in]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  connect_bd_net -net rst_ps7_0_150M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins rst_ps7_0_75M/peripheral_aresetn] [get_bd_pins video_lock_monitor/s_axi_aresetn]
  connect_bd_net -net rst_ps7_0_187M_peripheral_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins hls_ip_reset/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins rst_ps7_0_187M/peripheral_aresetn]
  connect_bd_net -net v_axi4s_vid_out_0_locked [get_bd_pins system_ila_0/probe1] [get_bd_pins vid_out/locked] [get_bd_pins video_lock_monitor/gpio_io_i]
  connect_bd_net -net vid_out_sof_state_out [get_bd_pins v_tc_0/sof_state] [get_bd_pins vid_out/sof_state_out]
  connect_bd_net -net vid_out_vid_active_video [get_bd_pins rgb2dvi_0/vid_pVDE] [get_bd_pins rgb2vga_0/rgb_pVDE] [get_bd_pins vid_out/vid_active_video]
  connect_bd_net -net vid_out_vid_data [get_bd_pins rgb2dvi_0/vid_pData] [get_bd_pins rgb2vga_0/rgb_pData] [get_bd_pins vid_out/vid_data]
  connect_bd_net -net vid_out_vid_hsync [get_bd_pins rgb2dvi_0/vid_pHSync] [get_bd_pins rgb2vga_0/rgb_pHSync] [get_bd_pins vid_out/vid_hsync]
  connect_bd_net -net vid_out_vid_vsync [get_bd_pins rgb2dvi_0/vid_pVSync] [get_bd_pins rgb2vga_0/rgb_pVSync] [get_bd_pins system_ila_0/probe2] [get_bd_pins vid_out/vid_vsync]
  connect_bd_net -net vid_out_vtg_ce [get_bd_pins system_ila_0/probe0] [get_bd_pins v_tc_0/gen_clken] [get_bd_pins vid_out/vtg_ce]

  # Create address segments
  assign_bd_address -offset 0x00000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces fbr/Data_m_axi_mm_video] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] -force
  assign_bd_address -offset 0x40020000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs fbr/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0x40010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hls_ip_reset/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video_lock_monitor/S_AXI/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.699051",
   "Default View_TopLeft":"-10,-66",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r6  2020-01-29 bk=1.5227 VDI=41 GEI=36 GUI=JA:10.0 non-TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 2090 -y 80 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 2090 -y 110 -defaultsOSRD
preplace port TMDS -pg 1 -lvl 6 -x 2090 -y 1010 -defaultsOSRD
preplace port vga_hs -pg 1 -lvl 6 -x 2090 -y 700 -defaultsOSRD
preplace port vga_vs -pg 1 -lvl 6 -x 2090 -y 730 -defaultsOSRD
preplace portBus vga_r -pg 1 -lvl 6 -x 2090 -y 610 -defaultsOSRD
preplace portBus vga_g -pg 1 -lvl 6 -x 2090 -y 640 -defaultsOSRD
preplace portBus vga_b -pg 1 -lvl 6 -x 2090 -y 670 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -x 1810 -y 190 -defaultsOSRD
preplace inst v_tc_0 -pg 1 -lvl 3 -x 950 -y 700 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 550 -y 271 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 190 -y 650 -defaultsOSRD
preplace inst video_lock_monitor -pg 1 -lvl 3 -x 950 -y 460 -defaultsOSRD
preplace inst rst_ps7_0_75M -pg 1 -lvl 1 -x 190 -y 240 -defaultsOSRD
preplace inst vid_out -pg 1 -lvl 4 -x 1330 -y 740 -defaultsOSRD
preplace inst hls_ip_reset -pg 1 -lvl 3 -x 950 -y 300 -defaultsOSRD
preplace inst rst_ps7_0_187M -pg 1 -lvl 1 -x 190 -y 440 -defaultsOSRD
preplace inst fbr -pg 1 -lvl 3 -x 950 -y 130 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -x 1330 -y 170 -defaultsOSRD
preplace inst system_ila_0 -pg 1 -lvl 5 -x 1810 -y 820 -defaultsOSRD
preplace inst rgb2vga_0 -pg 1 -lvl 5 -x 1810 -y 640 -defaultsOSRD
preplace inst rgb2dvi_0 -pg 1 -lvl 5 -x 1810 -y 1010 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 540 380 540 700 540 NJ 540 1580 370 2040
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 10 0 NJ 0 NJ 0 NJ 0 NJ 0 2050
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 400 770 NJ
preplace netloc processing_system7_0_FCLK_CLK2 1 0 6 20 140 390 461 760 550 1160 530 1540 530 2030
preplace netloc rst_ps7_0_150M_peripheral_aresetn 1 1 2 370 481 750J
preplace netloc v_axi4s_vid_out_0_locked 1 3 2 NJ 470 1560
preplace netloc processing_system7_0_FCLK_CLK1 1 0 6 20 340 410 451 710 220 1150 40 1590 10 2030
preplace netloc rst_ps7_0_187M_peripheral_aresetn 1 1 3 360 471 740 380 1130
preplace netloc hls_ip_reset_gpio_io_o 1 2 3 730 210 1120 560 1530
preplace netloc vid_out_vtg_ce 1 2 3 710 850 1170 570 1550
preplace netloc fbr_interrupt 1 3 2 1120J 50 1500
preplace netloc vid_out_vid_vsync 1 4 1 1570 650n
preplace netloc vid_out_vid_data 1 4 1 1500 610n
preplace netloc vid_out_vid_active_video 1 4 1 1520 650n
preplace netloc vid_out_vid_hsync 1 4 1 1510 630n
preplace netloc rgb2vga_0_vga_pRed 1 5 1 2050J 600n
preplace netloc rgb2vga_0_vga_pGreen 1 5 1 2060J 620n
preplace netloc rgb2vga_0_vga_pBlue 1 5 1 2050J 640n
preplace netloc rgb2vga_0_vga_pHSync 1 5 1 2040J 660n
preplace netloc rgb2vga_0_vga_pVSync 1 5 1 2030J 680n
preplace netloc vid_out_sof_state_out 1 2 3 750 910 NJ 910 1490
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 720 261n
preplace netloc fbr_m_axis_video 1 3 1 1140 130n
preplace netloc processing_system7_0_DDR 1 5 1 2060J 80n
preplace netloc ps7_0_axi_periph_M03_AXI 1 2 1 690 110n
preplace netloc rgb2dvi_0_TMDS 1 5 1 N 1010
preplace netloc fbr_m_axi_mm_video 1 3 1 N 110
preplace netloc v_tc_0_vtiming_out 1 3 1 N 680
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 700 280n
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 410 -10 NJ -10 NJ -10 NJ -10 2040
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ 110
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 N 170
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 730 241n
levelinfo -pg 1 -10 190 550 950 1330 1810 2090
pagesize -pg 1 -db -bbox -sgen -10 -70 2210 1130
"
}
...
# End of cr_bd_dsFBR1()
cr_bd_dsFBR1 ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files dsFBR1.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files dsFBR1.bd ] 
set_property IS_ENABLED "1" [get_files dsFBR1.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files dsFBR1.bd ] 
set_property IS_LOCKED "0" [get_files dsFBR1.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files dsFBR1.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files dsFBR1.bd ] 
set_property PFM_NAME "" [get_files dsFBR1.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files dsFBR1.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files dsFBR1.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files dsFBR1.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files dsFBR1.bd ] 
set_property USED_IN_SIMULATION "1" [get_files dsFBR1.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files dsFBR1.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse dsFBR1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../FBR1/FBR1.gen/sources_1/bd/dsFBR1/hdl/dsFBR1_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse dsFBR1.bd] -top]
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/FBR1.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/FBR1.srcs/utils_1/imports/impl_1" -objects $obj
